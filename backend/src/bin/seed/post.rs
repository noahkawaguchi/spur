...
pub async fn seed(pool: &PgPool) -> Result<()> {
    let posts = [
        ...
        SeedPost {
            ...
            created_at: anchor_offset(1, 11, 11)?,
            edited_at: None,
            archived_at: None,
            deleted_at: None,
        },
        ...
        SeedPost {
            ...
            created_at: anchor_offset(13, 4, 25)?,
            edited_at: Some(anchor_offset(3, 4, 30)?),
            archived_at: None,
            deleted_at: None,
        },
        // Post 4
        SeedPost {
            ...
            created_at: anchor_offset(40, 0, 50)?,
            edited_at: None,
            archived_at: None,
            deleted_at: None,
        },
        ...
        SeedPost {
            ...
            created_at: anchor_offset(250, 5, 52)?,
            edited_at: Some(anchor_offset(300, 10, 25)?),
            archived_at: None,
            deleted_at: None,
        },
        // Post 6
        SeedPost {
            ...
            created_at: anchor_offset(444, 4, 44)?,
            edited_at: None,
            archived_at: None,
            deleted_at: None,
        },
        ...
        SeedPost {
            ...
            created_at: anchor_offset(500, 15, 50)?,
            edited_at: None,
            archived_at: None,
            deleted_at: None,
        },
        ...
        SeedPost {
            ...
            created_at: anchor_offset(501, 23, 0)?,
            edited_at: Some(anchor_offset(501, 23, 5)?),
            archived_at: None,
            deleted_at: None,
        },
    ];
