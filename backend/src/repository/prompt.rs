...
//         sqlx::query_as!(PostInfo, "SELECT * FROM post WHERE id = $1", id)
//             .fetch_optional(&self.pool)
//             .await
//             .map_err(Into::into)
//     }

//     async fn single_user_prompts(&self, user_id: i32) -> Result<Vec<PostInfo>, TechnicalError> {
//         sqlx::query_as!(
//             PostInfo,
//             "
//             SELECT * FROM post 
...
//     async fn all_friend_prompts(&self, user_id: i32) -> Result<Vec<PostInfo>, TechnicalError> {
//         sqlx::query_as!(
//             PostInfo,
//             "
//             SELECT p.*
